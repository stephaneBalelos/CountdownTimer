function E() {
  ...
  for (const e of c) {
    ...
    const u = e.querySelector("[days]"), a = e.querySelector("[hours]"), d = e.querySelector("[minutes]"), l = e.querySelector("[seconds]");
    if (!u || !a || !d || !l) {
    ...
    const D = setInterval(() => {
      ...
      n(u, m.days, h), n(a, m.hours, q), n(d, m.minutes, H), n(l, m.seconds, g);
    }, 1e3);
  }
}
const n = (c, o, t) => {
